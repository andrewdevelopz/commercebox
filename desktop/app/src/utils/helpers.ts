...
export default class Helpers {
    ...
    /**
     *  @todo ALL methods below are deprecated and will be removed if not needed later on.
     */

    // /**
    //  *  This function allows the import of html files acting as components in the html.
    //  * 
    //  *  @todo - fix this to be more like the method inside Components class
    //  */
    // private includeHTML = async (): Promise<void> => {
    //     let tags: HTMLCollection, file: any, xhttp: Response;
    ...
    //                 tag.innerHTML = await xhttp.text();
    //                 // get the loaded HTML element and set it's attribute id to filename
    //                 const loadedHTML: HTMLElement = tag.querySelector('div') as HTMLElement;
    ...
    //             } catch (e) {
    //                 console.error(e);
    //                 tag.innerHTML = 'HTML component not found';
    //             } finally {
